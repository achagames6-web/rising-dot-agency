...
const placeholderBlogs = [
  {
    ...
    excerpt: 'Discover the latest features in Next.js 14 and how to leverage them for building fast, scalable web applications.',
...
Next.js 14 is a game-changer for web development. Start building your next project with it today!`,
  ...
  },
  {
    ...
    excerpt: 'Learn the latest trends and best practices in UI/UX design that will dominate the digital landscape in 2025.',
...
Great design is about solving problems while delighting users. Keep learning and experimenting!`,
  ...
  },
  {
    ...
    excerpt: 'Discover how n8n can help you automate repetitive tasks and streamline your business operations.',
...
Automation is no longer optional. Start automating today with n8n!`,
  ...
  },
  {
    ...
    excerpt: 'Cut through the noise and learn SEO strategies that deliver real results for your website.',
