...
const defaultHeroContent: HeroContent = {
  ...
  video: '/media/services/saas/hero/saas-dashboard.mp4', // Will use video if exists, otherwise falls back to image
};
...
export default function SaasPage() {
  ...
  const roiCalculator = roiCalculatorContent || defaultROICalculatorContent;
  const featureRequest = featureRequestContent || defaultFeatureRequestContent;

  return (
    <main className="min-h-screen bg-black">
      {/* Hero Section - Uses CMS content with fallback, supports video or image */}
      <GradientHero
        badge={hero.badge}
