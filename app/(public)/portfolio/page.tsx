...
const defaultTags = [
  'Web Design', 'Shopify', 'WordPress', 'SEO', 'Chatbot Development', 'N8N Automations',
  'React', 'Next.js', 'Tailwind', 'TypeScript', 'Figma', 'Stripe', 'OpenAI', 'Analytics', 'SaaS', 'AI/ML'
];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <ImageAccordionHero
        ...
        subtitle={heroContent?.subtitle || 'Explore our work across web design, e-commerce, automation, chatbots, and SEO. Each project showcases our commitment to excellence and innovation.'}
        ctaButton={{
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            ...
            subtitle={filtersContent?.subtitle || 'Drag and explore the technologies we master to bring your vision to life'}
          />
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            ...
            subtitle={gridContent?.subtitle || 'Explore our complete collection of successful client projects'}
          />
          <motion.div
            layout
      ...
      <MiniCTA
        ...
        subtitle={ctaContent?.subtitle || 'Let\'s create something extraordinary together. Get in touch today.'}
