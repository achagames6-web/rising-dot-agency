...
export default function ContactMap() {
  ...
  return (
    <div className="relative h-[500px] rounded-2xl overflow-hidden border border-[#64748B]/20">
        ...
        {markers.map((marker) => (
          ...
          >
            ...
            >
              ...
              {/* Pin icon */}
              <div className="relative w-10 h-10 rounded-full bg-[#2563EB] border-2 border-white shadow-lg flex items-center justify-center text-white text-xl">
                📍
              </div>
            ...
            {(hoveredMarker === marker.id || selectedMarker === marker.id) && (
              ...
              >
                <h4 className="font-bold text-white mb-1">{marker.label}</h4>
      ...
      <div className="absolute top-4 right-4 flex flex-col gap-2 z-20">
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="w-10 h-10 rounded-lg bg-[#1E293B] hover:bg-[#2563EB] transition-colors flex items-center justify-center text-white border border-[#64748B]/30"
        >
          +
        </motion.button>
        <motion.button
      ...
      {/* Legend */}
      <div className="absolute bottom-4 left-4 p-4 bg-[#1E293B]/90 backdrop-blur-sm rounded-lg border border-[#64748B]/30">
        ...
        <div className="space-y-1 text-xs text-[#64748B]">
          ...
          <div className="flex items-center gap-2">
            <div className="w-3 h-1 bg-[#2563EB]" />
            <span>Routes</span>
          </div>
        </div>
      </div>
