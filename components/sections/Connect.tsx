...
export default function Connect() {
  ...
  const services = connectContent?.services || ['Chatbots', 'N8N Automation', 'Web Development', 'Shopify'];
                ...
                <div className="flex h-full flex-col justify-center gap-12 p-6 md:h-[400px] md:flex-row">
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-4 md:-mt-4 md:ml-12 md:w-[450px]">
                    <div className="flex flex-col items-center md:items-start">
                      <h3 className="mt-6 pb-1 font-bold font-montserrat">
                        <span className="text-2xl md:text-4xl text-[#37AFE1]">
                          {title}
                        </span>
                      </h3>
                    </div>
                    <p className="mb-4 text-[#64748B] font-inter">
                      {subtitle}
                    </p>
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          "border-[#37AFE1]/30 hover:bg-[#37AFE1]/10 hover:border-[#37AFE1]"
                        )}
                      >
                        <span className="flex items-center gap-1">
                          <Mail strokeWidth={1} className="h-5 w-5 text-[#37AFE1]" />
                        </span>
                      </Link>
                      <Link
