  ...
  return (
    <div className="w-full bg-black font-sans md:px-10" ref={containerRef}>
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl font-montserrat text-lg font-bold text-white md:text-4xl">
          Rising Dot Journey
        </h2>
        <p className="max-w-sm text-sm text-neutral-400 md:text-base">
          Our evolution in digital innovation and automation
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full border border-[#37AFE1]/30 bg-black md:left-3">
                <div className="h-4 w-4 rounded-full border border-[#F58122] bg-[#37AFE1] p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-[#F58122] from-[0%] via-[#37AFE1] via-[10%] to-transparent"
          />
        </div>
      </div>
    </div>
