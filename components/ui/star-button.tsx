...
export function StarButton({
  ...
  const finalBgColor = backgroundColor !== '#F58122' && backgroundColor !== 'currentColor' ? backgroundColor : bgColor;
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute aspect-square z-[2] animate-star-btn"
        style={
          {
            offsetPath: "var(--path)",
            offsetDistance: "0%",
      ...
      {/* Text layer */}
      <span 
        className="z-10 relative inline-flex items-center gap-2 font-semibold"
